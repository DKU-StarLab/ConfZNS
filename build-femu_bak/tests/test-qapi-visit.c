...
bool visit_type_q_obj_intList_wrapper_members(Visitor *v, q_obj_intList_wrapper *obj, Error **errp)
{
    if (!visit_type_intList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_int8List_wrapper_members(Visitor *v, q_obj_int8List_wrapper *obj, Error **errp)
{
    if (!visit_type_int8List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_int16List_wrapper_members(Visitor *v, q_obj_int16List_wrapper *obj, Error **errp)
{
    if (!visit_type_int16List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_int32List_wrapper_members(Visitor *v, q_obj_int32List_wrapper *obj, Error **errp)
{
    if (!visit_type_int32List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_int64List_wrapper_members(Visitor *v, q_obj_int64List_wrapper *obj, Error **errp)
{
    if (!visit_type_int64List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_uint8List_wrapper_members(Visitor *v, q_obj_uint8List_wrapper *obj, Error **errp)
{
    if (!visit_type_uint8List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_uint16List_wrapper_members(Visitor *v, q_obj_uint16List_wrapper *obj, Error **errp)
{
    if (!visit_type_uint16List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_uint32List_wrapper_members(Visitor *v, q_obj_uint32List_wrapper *obj, Error **errp)
{
    if (!visit_type_uint32List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_uint64List_wrapper_members(Visitor *v, q_obj_uint64List_wrapper *obj, Error **errp)
{
    if (!visit_type_uint64List(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_numberList_wrapper_members(Visitor *v, q_obj_numberList_wrapper *obj, Error **errp)
{
    if (!visit_type_numberList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_boolList_wrapper_members(Visitor *v, q_obj_boolList_wrapper *obj, Error **errp)
{
    if (!visit_type_boolList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_strList_wrapper_members(Visitor *v, q_obj_strList_wrapper *obj, Error **errp)
{
    if (!visit_type_strList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_sizeList_wrapper_members(Visitor *v, q_obj_sizeList_wrapper *obj, Error **errp)
{
    if (!visit_type_sizeList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_anyList_wrapper_members(Visitor *v, q_obj_anyList_wrapper *obj, Error **errp)
{
    if (!visit_type_anyList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_q_obj_StatusList_wrapper_members(Visitor *v, q_obj_StatusList_wrapper *obj, Error **errp)
{
    if (!visit_type_StatusList(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}

bool visit_type_UserDefListUnionKind(Visitor *v, const char *name,
                 UserDefListUnionKind *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &UserDefListUnionKind_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type_UserDefListUnion_members(Visitor *v, UserDefListUnion *obj, Error **errp)
{
    if (!visit_type_UserDefListUnionKind(v, "type", &obj->type, errp)) {
        return false;
    }
    switch (obj->type) {
    case USER_DEF_LIST_UNION_KIND_INTEGER:
        return visit_type_q_obj_intList_wrapper_members(v, &obj->u.integer, errp);
    case USER_DEF_LIST_UNION_KIND_S8:
        return visit_type_q_obj_int8List_wrapper_members(v, &obj->u.s8, errp);
    case USER_DEF_LIST_UNION_KIND_S16:
        return visit_type_q_obj_int16List_wrapper_members(v, &obj->u.s16, errp);
    case USER_DEF_LIST_UNION_KIND_S32:
        return visit_type_q_obj_int32List_wrapper_members(v, &obj->u.s32, errp);
    case USER_DEF_LIST_UNION_KIND_S64:
        return visit_type_q_obj_int64List_wrapper_members(v, &obj->u.s64, errp);
    case USER_DEF_LIST_UNION_KIND_U8:
        return visit_type_q_obj_uint8List_wrapper_members(v, &obj->u.u8, errp);
    case USER_DEF_LIST_UNION_KIND_U16:
        return visit_type_q_obj_uint16List_wrapper_members(v, &obj->u.u16, errp);
    case USER_DEF_LIST_UNION_KIND_U32:
        return visit_type_q_obj_uint32List_wrapper_members(v, &obj->u.u32, errp);
    case USER_DEF_LIST_UNION_KIND_U64:
        return visit_type_q_obj_uint64List_wrapper_members(v, &obj->u.u64, errp);
    case USER_DEF_LIST_UNION_KIND_NUMBER:
        return visit_type_q_obj_numberList_wrapper_members(v, &obj->u.number, errp);
    case USER_DEF_LIST_UNION_KIND_BOOLEAN:
        return visit_type_q_obj_boolList_wrapper_members(v, &obj->u.boolean, errp);
    case USER_DEF_LIST_UNION_KIND_STRING:
        return visit_type_q_obj_strList_wrapper_members(v, &obj->u.string, errp);
    case USER_DEF_LIST_UNION_KIND_SIZES:
        return visit_type_q_obj_sizeList_wrapper_members(v, &obj->u.sizes, errp);
    case USER_DEF_LIST_UNION_KIND_ANY:
        return visit_type_q_obj_anyList_wrapper_members(v, &obj->u.any, errp);
    case USER_DEF_LIST_UNION_KIND_USER:
        return visit_type_q_obj_StatusList_wrapper_members(v, &obj->u.user, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type_UserDefListUnion(Visitor *v, const char *name,
                 UserDefListUnion **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(UserDefListUnion), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_UserDefListUnion_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_q_obj_str_wrapper_members(Visitor *v, q_obj_str_wrapper *obj, Error **errp)
{
...
bool visit_type___org_qemu_x_Union1Kind(Visitor *v, const char *name,
                 __org_qemu_x_Union1Kind *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &__org_qemu_x_Union1Kind_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type___org_qemu_x_Union1_members(Visitor *v, __org_qemu_x_Union1 *obj, Error **errp)
{
    if (!visit_type___org_qemu_x_Union1Kind(v, "type", &obj->type, errp)) {
        return false;
    }
    switch (obj->type) {
    case ORG_QEMU_X_UNION1_KIND___ORG_QEMU_X_BRANCH:
        return visit_type_q_obj_str_wrapper_members(v, &obj->u.__org_qemu_x_branch, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type___org_qemu_x_Union1(Visitor *v, const char *name,
                 __org_qemu_x_Union1 **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(__org_qemu_x_Union1), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type___org_qemu_x_Union1_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type___org_qemu_x_Union1List(Visitor *v, const char *name,
                 __org_qemu_x_Union1List **obj, Error **errp)
{
    bool ok = false;
    ...
    for (tail = *obj; tail;
        ...
        if (!visit_type___org_qemu_x_Union1(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
{
    if (!visit_type___org_qemu_x_Union1List(v, "array", &obj->array, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type___org_qemu_x_Union2_members(Visitor *v, __org_qemu_x_Union2 *obj, Error **errp)
{
    if (!visit_type___org_qemu_x_Base_members(v, (__org_qemu_x_Base *)obj, errp)) {
        return false;
    }
...
bool visit_type___org_qemu_x_Union2(Visitor *v, const char *name,
                 __org_qemu_x_Union2 **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(__org_qemu_x_Union2), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type___org_qemu_x_Union2_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_q_obj___org_qemu_x_command_arg_members(Visitor *v, q_obj___org_qemu_x_command_arg *obj, Error **errp)
{
    ...
    if (!visit_type___org_qemu_x_Union2(v, "c", &obj->c, errp)) {
        return false;
    }
...
bool visit_type_q_obj_TestStruct_wrapper_members(Visitor *v, q_obj_TestStruct_wrapper *obj, Error **errp)
{
    if (!visit_type_TestStruct(v, "data", &obj->data, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type_TestIfUnionKind(Visitor *v, const char *name,
                 TestIfUnionKind *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &TestIfUnionKind_lookup, errp);
    *obj = value;
    return ok;
}
...
{
    if (!visit_type_TestIfUnionKind(v, "type", &obj->type, errp)) {
        return false;
    }
    switch (obj->type) {
    case TEST_IF_UNION_KIND_FOO:
        return visit_type_q_obj_TestStruct_wrapper_members(v, &obj->u.foo, errp);
#if defined(TEST_IF_UNION_BAR)
    case TEST_IF_UNION_KIND_UNION_BAR:
        return visit_type_q_obj_str_wrapper_members(v, &obj->u.union_bar, errp);
...
bool visit_type_q_obj_TestIfUnionCmd_arg_members(Visitor *v, q_obj_TestIfUnionCmd_arg *obj, Error **errp)
{
    if (!visit_type_TestIfUnion(v, "union_cmd_arg", &obj->union_cmd_arg, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type_q_obj_TestIfAlternateCmd_arg_members(Visitor *v, q_obj_TestIfAlternateCmd_arg *obj, Error **errp)
{
    if (!visit_type_TestIfAlternate(v, "alt_cmd_arg", &obj->alt_cmd_arg, errp)) {
        return false;
    }
    return true;
}
...
#if defined(TEST_IF_STRUCT)
bool visit_type_q_obj_TestIfCmd_arg_members(Visitor *v, q_obj_TestIfCmd_arg *obj, Error **errp)
{
...
bool visit_type_q_obj_TestIfEvent_arg_members(Visitor *v, q_obj_TestIfEvent_arg *obj, Error **errp)
{
    if (!visit_type_TestIfStruct(v, "foo", &obj->foo, errp)) {
        return false;
    }
