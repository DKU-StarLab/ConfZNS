...
bool visit_type_q_obj_TPMPassthroughOptions_wrapper_members(Visitor *v, q_obj_TPMPassthroughOptions_wrapper *obj, Error **errp)
{
...
bool visit_type_q_obj_TPMEmulatorOptions_wrapper_members(Visitor *v, q_obj_TPMEmulatorOptions_wrapper *obj, Error **errp)
{
...
bool visit_type_TpmTypeOptionsKind(Visitor *v, const char *name,
                 TpmTypeOptionsKind *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &TpmTypeOptionsKind_lookup, errp);
    *obj = value;
    return ok;
}
...
{
    if (!visit_type_TpmTypeOptionsKind(v, "type", &obj->type, errp)) {
        return false;
    }
    switch (obj->type) {
    case TPM_TYPE_OPTIONS_KIND_PASSTHROUGH:
        return visit_type_q_obj_TPMPassthroughOptions_wrapper_members(v, &obj->u.passthrough, errp);
    case TPM_TYPE_OPTIONS_KIND_EMULATOR:
        return visit_type_q_obj_TPMEmulatorOptions_wrapper_members(v, &obj->u.emulator, errp);
    default:
        abort();
    }
    return true;
