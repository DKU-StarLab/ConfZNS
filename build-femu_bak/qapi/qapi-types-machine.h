...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfo, qapi_free_CpuInfo)

void qapi_free_CpuInfoX86(CpuInfoX86 *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoX86, qapi_free_CpuInfoX86)

void qapi_free_CpuInfoSPARC(CpuInfoSPARC *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoSPARC, qapi_free_CpuInfoSPARC)

void qapi_free_CpuInfoPPC(CpuInfoPPC *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoPPC, qapi_free_CpuInfoPPC)

void qapi_free_CpuInfoMIPS(CpuInfoMIPS *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoMIPS, qapi_free_CpuInfoMIPS)

void qapi_free_CpuInfoTricore(CpuInfoTricore *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoTricore, qapi_free_CpuInfoTricore)

void qapi_free_CpuInfoRISCV(CpuInfoRISCV *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoRISCV, qapi_free_CpuInfoRISCV)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CpuInfoList, qapi_free_CpuInfoList)
