...
bool visit_type_MigrateSetParameters_members(Visitor *v, MigrateSetParameters *obj, Error **errp)
{
    ...
    if (visit_optional(v, "compress-level", &obj->has_compress_level)) {
        if (!visit_type_int(v, "compress-level", &obj->compress_level, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "compress-threads", &obj->has_compress_threads)) {
        if (!visit_type_int(v, "compress-threads", &obj->compress_threads, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "decompress-threads", &obj->has_decompress_threads)) {
        if (!visit_type_int(v, "decompress-threads", &obj->decompress_threads, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "throttle-trigger-threshold", &obj->has_throttle_trigger_threshold)) {
        if (!visit_type_int(v, "throttle-trigger-threshold", &obj->throttle_trigger_threshold, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "cpu-throttle-initial", &obj->has_cpu_throttle_initial)) {
        if (!visit_type_int(v, "cpu-throttle-initial", &obj->cpu_throttle_initial, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "cpu-throttle-increment", &obj->has_cpu_throttle_increment)) {
        if (!visit_type_int(v, "cpu-throttle-increment", &obj->cpu_throttle_increment, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "max-bandwidth", &obj->has_max_bandwidth)) {
        if (!visit_type_int(v, "max-bandwidth", &obj->max_bandwidth, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "downtime-limit", &obj->has_downtime_limit)) {
        if (!visit_type_int(v, "downtime-limit", &obj->downtime_limit, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "x-checkpoint-delay", &obj->has_x_checkpoint_delay)) {
        if (!visit_type_int(v, "x-checkpoint-delay", &obj->x_checkpoint_delay, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "multifd-channels", &obj->has_multifd_channels)) {
        if (!visit_type_int(v, "multifd-channels", &obj->multifd_channels, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "max-cpu-throttle", &obj->has_max_cpu_throttle)) {
        if (!visit_type_int(v, "max-cpu-throttle", &obj->max_cpu_throttle, errp)) {
            return false;
        }
    }
    ...
    if (visit_optional(v, "multifd-zlib-level", &obj->has_multifd_zlib_level)) {
        if (!visit_type_int(v, "multifd-zlib-level", &obj->multifd_zlib_level, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "multifd-zstd-level", &obj->has_multifd_zstd_level)) {
        if (!visit_type_int(v, "multifd-zstd-level", &obj->multifd_zstd_level, errp)) {
            return false;
        }
    }
