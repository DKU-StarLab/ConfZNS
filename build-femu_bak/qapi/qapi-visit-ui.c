...
bool visit_type_q_obj_int_wrapper_members(Visitor *v, q_obj_int_wrapper *obj, Error **errp)
{
...
bool visit_type_q_obj_QKeyCode_wrapper_members(Visitor *v, q_obj_QKeyCode_wrapper *obj, Error **errp)
{
...
bool visit_type_KeyValue_members(Visitor *v, KeyValue *obj, Error **errp)
{
    ...
    case KEY_VALUE_KIND_NUMBER:
        return visit_type_q_obj_int_wrapper_members(v, &obj->u.number, errp);
    case KEY_VALUE_KIND_QCODE:
        return visit_type_q_obj_QKeyCode_wrapper_members(v, &obj->u.qcode, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type_q_obj_InputKeyEvent_wrapper_members(Visitor *v, q_obj_InputKeyEvent_wrapper *obj, Error **errp)
{
...
bool visit_type_q_obj_InputBtnEvent_wrapper_members(Visitor *v, q_obj_InputBtnEvent_wrapper *obj, Error **errp)
{
...
bool visit_type_q_obj_InputMoveEvent_wrapper_members(Visitor *v, q_obj_InputMoveEvent_wrapper *obj, Error **errp)
{
...
bool visit_type_InputEvent_members(Visitor *v, InputEvent *obj, Error **errp)
{
    ...
    case INPUT_EVENT_KIND_KEY:
        return visit_type_q_obj_InputKeyEvent_wrapper_members(v, &obj->u.key, errp);
    case INPUT_EVENT_KIND_BTN:
        return visit_type_q_obj_InputBtnEvent_wrapper_members(v, &obj->u.btn, errp);
    case INPUT_EVENT_KIND_REL:
        return visit_type_q_obj_InputMoveEvent_wrapper_members(v, &obj->u.rel, errp);
    case INPUT_EVENT_KIND_ABS:
        return visit_type_q_obj_InputMoveEvent_wrapper_members(v, &obj->u.abs, errp);
    default:
        abort();
    }
    return true;
