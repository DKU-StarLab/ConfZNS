...
uint16_t _TRACE_VFIO_MIGRATION_PROBE_DSTATE;
...
uint16_t _TRACE_VFIO_SAVE_BUFFER_DSTATE;
uint16_t _TRACE_VFIO_UPDATE_PENDING_DSTATE;
uint16_t _TRACE_VFIO_SAVE_DEVICE_CONFIG_STATE_DSTATE;
uint16_t _TRACE_VFIO_SAVE_PENDING_DSTATE;
...
TraceEvent _TRACE_VFIO_MIGRATION_PROBE_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_migration_probe",
    .sstate = TRACE_VFIO_MIGRATION_PROBE_ENABLED,
    .dstate = &_TRACE_VFIO_MIGRATION_PROBE_DSTATE 
};
...
TraceEvent _TRACE_VFIO_SAVE_BUFFER_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_save_buffer",
    .sstate = TRACE_VFIO_SAVE_BUFFER_ENABLED,
    .dstate = &_TRACE_VFIO_SAVE_BUFFER_DSTATE 
};
TraceEvent _TRACE_VFIO_UPDATE_PENDING_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_update_pending",
    .sstate = TRACE_VFIO_UPDATE_PENDING_ENABLED,
    .dstate = &_TRACE_VFIO_UPDATE_PENDING_DSTATE 
};
...
TraceEvent _TRACE_VFIO_SAVE_PENDING_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "vfio_save_pending",
    .sstate = TRACE_VFIO_SAVE_PENDING_ENABLED,
    .dstate = &_TRACE_VFIO_SAVE_PENDING_DSTATE 
};
...
TraceEvent *hw_vfio_trace_events[] = {
    ...
    &_TRACE_VFIO_MIGRATION_PROBE_EVENT,
    ...
    &_TRACE_VFIO_SAVE_BUFFER_EVENT,
    &_TRACE_VFIO_UPDATE_PENDING_EVENT,
    &_TRACE_VFIO_SAVE_DEVICE_CONFIG_STATE_EVENT,
    &_TRACE_VFIO_SAVE_PENDING_EVENT,
